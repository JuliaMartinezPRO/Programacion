...
public class EjerciciosCondicionales {
    ...
    public static void main(String[] args) {
        ...
        //Pedir al usuario que introduzca una nota
        System.out.println("Ingrese una nota");
        double notta = src.nextDouble();
        //Definir rango
        if (nota < 0 || nota > 10) {
            System.out.println("aprobado" + notta);
        } else {
            System.out.println("suspenso" + notta);
        }
